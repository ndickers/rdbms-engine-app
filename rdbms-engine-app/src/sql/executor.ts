...
import type { SQLCommand } from "./types.js";
import type { DatabaseManager } from "../core/DatabaseManager.js";


function executeTableSQL(db: Database, cmd: SQLCommand): any {
    switch (cmd.type) {
        case "CREATE_TABLE":
...
export function executeSQL(manager: DatabaseManager, cmd: SQLCommand | any): any {
    switch (cmd.type) {
